              ...
              <div className="p-6">
                ...
                {activeTab === "text" && (
                  <div className="animate-fade-in">
                    ...
                    {/* Char count + Sensitivity + Translate */}
                ...
                {activeTab === "url" && (
                  <div className="animate-fade-in space-y-4">
                    ...
                    <Button className="w-full" size="lg" onClick={handleAnalyzeUrl} disabled={loading} data-analyze-url>
            ...
            {result ? (
                ...
                <div className={`card-enterprise p-6 animate-fade-up relative overflow-hidden ${result.prediction === "FAKE" ? "border-verdict-fake" : "border-verdict-real"}`}>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <button onClick={() => { addBookmarkFn(result, inputText); toast('Bookmarked!', 'success') }}
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-secondary rounded-xl border border-border p-6 space-y-4 animate-fade-up">
                  <div className="flex items-center gap-4">
                    <div className="animate-pulse bg-muted rounded-full w-16 h-16" />
                    <div className="space-y-2 flex-1"><div className="animate-pulse bg-muted rounded-lg h-5 w-24" /><div className="animate-pulse bg-muted rounded-lg h-3 w-32" /></div>
                  </div>
                  <div className="animate-pulse bg-muted rounded-lg h-2 w-full" />
                  <div className="animate-pulse bg-muted rounded-lg h-2 w-4/5" />
                  <div className="animate-pulse bg-muted rounded-lg h-2 w-3/5" />
                </div>
