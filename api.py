...
if not FASTAPI_AVAILABLE:
    ...
    # API Key management (load from environment)
    API_KEYS = {
        "demo_key_123": "demo_user",
        "prod_key_456": "production_user"
    }
    
    # Support custom API key from environment
    ...
    class BatchArticle(BaseModel):
        ...
        def validate_id(cls, v):
            ...
            if len(v) > 100:
                raise ValueError("Article ID must not exceed 100 characters")
            return v
    ...
    class BatchRequest(BaseModel):
        ...
        def validate_articles(cls, v):
            ...
            if len(v) > 50:
                raise ValueError("Batch size cannot exceed 50 articles")
            return v
    ...
    async def health_check():
        """Health check endpoint - quick status without dependencies"""
        return {
            "status": "healthy",
    ...
    async def api_status():
        ...
        return {
            ...
            "memory_usage_mb": memory_info.rss / 1024 / 1024 if memory_info else None,
